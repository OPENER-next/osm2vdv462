        ...
        if edge["edge_type"] == "crossing":
            ...
            if edge["crossing_type"] == "generated":
                ...
                if edge["from_node_osm_id"] != 0:
                    insertPathsElementsRef(cur, pathId, 'N', edge["from_node_osm_id"])
                else:
                    insertPathsElementsRef(cur, pathId, 'N', edge["to_node_osm_id"])
                insertPathsElementsRef(cur, pathId, 'W', abs(edge["osm_way_id"]))
            else:
            ...
            # negative value of osm_way_id is the id of the node
            insertPathsElementsRef(cur, pathId, 'N', abs(edge["osm_way_id"]))
        else:
